 ...
 *     @file law-grid-organizer-academic.js
 *     @see Seattle University School of Law Newsroom
 *
 *     This new content type layout is a smart layout for academic category feed
 *     news items that must obey a masonry grid layout. In its first iteration
 *     this layout will be dedicated to the category news pages.
 *
