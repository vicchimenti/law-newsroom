...
var optionToTestFor = "announcements"; //edit this to change the option
var contentTypeLayout = 'output/announcementsfeed'; //edit this to change the Content Layout to use for output
