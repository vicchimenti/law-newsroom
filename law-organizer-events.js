...
var optionToTestFor = "events"; //edit this to change the option
var contentTypeLayout = 'output/eventsfeed'; //edit this to change the Content Layout to use for output
