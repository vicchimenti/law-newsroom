...
try {
    ...
    // declare content wrappers
    header = '<div class="heroOrganizerWrapper contentItem col-xs-12" id="id' + content.getID() + '" data-position-default="Main" data-position-selected="Main"><div class="heroOrganizer standardContent card"><div class="heroOrganizerExtra"></div>';
    midder = '<span></span>';
