...
try {
    ...
    // declare content wrappers
    header = '<div class="heroOrganizerWrapper contentItem col-xs-12 order-xs-1 col-md-12 order-md-first" id="id' + content.getID() + '" data-position-default="Main" data-position-selected="Main"><div class="heroOrganizer standardContent card"><div class="heroOrganizerExtra"></div>';
    midder = '<span></span>';
