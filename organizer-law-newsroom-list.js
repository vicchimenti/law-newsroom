...
try {
	...
	header = '<div class="newsroomOrganizerWrapper contentItem col-xs-12 col-md-6 offset-md-3" id="id' + content.getID() + '" data-position-default="Main" data-position-selected="Main"><div class="newsroomOrganizer standardContent card-group"><div class="newsroomOrganizerExtra"></div>';
	midder = '<span></span>';
