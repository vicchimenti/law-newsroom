...
try {
	...
	default:
		header = '\
			<div class="newsroomOrganizerWrapper contentItem col-xs-12 col-md-8 col-md-push-4" id="id' + content.getID() + '" data-position-default="MainZone" data-position-selected="MainZone">\
