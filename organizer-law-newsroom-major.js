...
try {
    ...
    switch (choice) {
        default: header = '\
			<div class="newsroomOrganizerWrapper contentItem major-feed col-12 col-xs-12 order-xs-2 col-md-8 col-md-push-4 order-md-3" id="id' + content.getID() + '" data-position-default="Main" data-position-selected="Main">\
