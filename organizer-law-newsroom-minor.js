...
try {
	...
	default:
		header = '\
			<div class="newsroomOrganizerWrapper contentItem col-xs-12 col-md-4 col-md-pull-8" id="id' + content.getID() + '" data-position-default="MainZone" data-position-selected="MainZone">\
